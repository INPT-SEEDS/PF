...
public class RouteSegmentation2
{
	...
	public static void Segment(int maxDistance)
	{
		...
		{		
			...
			//-------the-list-of-points-we-would-write-in-the-document
			Track track=MyXMLParser.getRoute();
			...
			for(Track subTrack:subTracks)
			{
				...
				if(t)attr2.setValue("0");
				else attr2.setValue("1");
				t=!t;
			...
			StreamResult result = new StreamResult(new File("segmentsOfRoute.xml"));
